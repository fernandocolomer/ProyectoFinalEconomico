...
public class ActivityRegistrarUsuario extends AppCompatActivity {
                        ...
                        if (response.length() > 0) {
                            try {
                                ...
                                if (resp.getString(0).equals("Se a registrado correctamente.")) {
                                    ...
                                    Intent newPassword = new Intent(getApplicationContext(), com.aplicacion.ecomicospro.ActivityLogin.class);
    ...
    private void onClickBack(View view) {
        Intent login = new Intent(getApplicationContext(), com.aplicacion.ecomicospro.ActivityLogin.class);
        startActivity(login);
        finish();
    }
