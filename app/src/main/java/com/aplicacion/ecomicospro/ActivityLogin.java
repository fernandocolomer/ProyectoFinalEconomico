package com.aplicacion.ecomicospro;
...
import com.aplicacion.ecomicospro.Configurations.ApiConfigurations.ApiConfigurations;
import com.aplicacion.ecomicospro.Configurations.SQLiteConnection.SQLiteConnections;
import com.aplicacion.ecomicospro.Configurations.SQLiteConnection.Transactions;
import com.aplicacion.ecomicospro.Utilities.Utilities;
                            ...
                            try {
                                ...
                                if (resp.length() > 1){
                                    if (saveNewCredentials(resp.getInt(1), resp.getString(2))){
                                        ...
                                        Intent dashboard = new Intent(getApplicationContext(), DashboardCliente.class);
                                        startActivity(dashboard);
                                        finish();
                                    }
