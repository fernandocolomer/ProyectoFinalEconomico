...
ClipData.Item item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //idpro=(EditText)findViewById(R.id.) ;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, ApiConfigurations.getAllProductsEndpoint,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    JSONArray productoArray = response.getJSONArray("products");
                    //listaUsuarios.clear();
                    for (int i = 0; i < productoArray.length(); i++) {
                        JSONObject RowProductos = productoArray.getJSONObject(i);
                        Products  product = new Products();
                        product.setPid(RowProductos.getString("pid").toString());
                        product.setNombre(RowProductos.getString("nombre").toString());
                    ...
                    Toast.makeText(getApplicationContext(), "No tienes productos", Toast.LENGTH_SHORT).show();
                }
            }
